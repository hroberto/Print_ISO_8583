...
void teste_iso_bsp_microseguros()
{
...
{
    std::cout << "******* teste_iso_bsp_microseguros ***** \n";
    teste_iso_bsp_microseguros();

    std::cout << "******* teste_iso_farmaRouter ***** \n";
    teste_iso_farmaRouter();
